...
public class Title {
    ...
    public boolean isNew(){
       for(Title b : BookController.titleMap.values()){
           if(b.getCode().contentEquals(this.getCode())) return false;
       }
       return true;
   }
   public void setBook(@NotNull Title title){
        ...
        this.amount = title.amount;
        this.available = title.available;
        this.shelf = title.shelf;
   }
    public Title(String ce, String n, String cy, String a, String p, int y, int at, int ae, String s) {
    ...
    private boolean isValid(String name){
        ...
        for(Character c : chars){
            if(!(Character.isLetterOrDigit(c) || Character.isWhitespace(c) || c == '-' )) return false;
        }
        return true;
    }
    ...
    public boolean equals(Object o) {
        ...
        Title title = (Title) o;
        System.out.println(title.getCode());
        return Objects.equals(this.getCode(), title.getCode());
    }
